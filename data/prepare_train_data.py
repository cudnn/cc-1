...
parser.add_argument("--dataset_dir", metavar='DIR',
                    ...
                    help = 'path to original dataset', default = 'seq')

parser.add_argument("--dataset-format", type=str, default=None, choices=["kitti", "cityscapes"])
...
parser.add_argument("--dump-root", type=str, default='seq_256512', help="Where to dump the data")
