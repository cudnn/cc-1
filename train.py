...
parser.add_argument('--data', metavar='DIR',default='/home/roit/datasets/kitti_small_128512',
...
parser.add_argument('--with-depth-gt', action='store_true',default=True, help='use ground truth for depth validation. \
...
#modeldict
parser.add_argument('--pretrained-disp', dest='pretrained_disp', default=None, metavar='/home/roit/models/cc/geometry/dispnet_k.pth.tar',
                    help='path to pre-trained dispnet model')
parser.add_argument('--pretrained-mask', dest='pretrained_mask', default=None, metavar='/home/roit/models/cc/geometry/masknet.pth.tar',
                    help='path to pre-trained Exp Pose net model')
parser.add_argument('--pretrained-pose', dest='pretrained_pose', default=None, metavar='/home/roit/models/cc/geometry/posenet.pth.tar',
                    help='path to pre-trained Exp Pose net model')
parser.add_argument('--pretrained-flow', dest='pretrained_flow', default=None, metavar='/home/roit/models/cc/geometry/flownets_EPE1.951.pth.tar',
...
parser.add_argument('--fix-masknet', dest='fix_masknet', action='store_true',default=True, help='do not train posenet')
parser.add_argument('--fix-posenet', dest='fix_posenet', action='store_true',default=True, help='do not train posenet')
...
parser.add_argument('--log-terminal', action='store_true', default=False,help='will display progressbar at terminal')
...
#3. main cycle
    for epoch in range(args.epochs):
        ...
        #3.5 save model and remember lowest error and save checkpoint
