...
class inference_framework_Sequence(object):
    def __init__(self, root,  seq_length=3, step=1):
        self.root = root
        self.img_files, self.sample_indices = read_scene_data(self.root,  seq_length, step)
...
def read_scene_data(data_root, seq_length=3, step=1):
    #
    ...
    #    corresponding_dirs = set((data_root/'imgs').dirs(seq))
    ...
    for sequence in tqdm(sequences):
        ...
        imgs = sorted((data_root/'imgs').files('*.png'))
